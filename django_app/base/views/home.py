...
def home(request):
    ...
    quick_link_cards = {
        'donate': ("<strong>Donnez</strong> pour eux",
                   'https://www.helloasso.com/associations/pccn#crowdfunding'),
        'adopt': ("Devenez <strong>famille d'accueil</strong>",
                  '/adoption'),
        'volunteer': ("Devenez <strong>bénévole</strong>",
                      'https://www.helloasso.com/associations/pccn/adhesions/adhesion-1'),
    }
    context = {
