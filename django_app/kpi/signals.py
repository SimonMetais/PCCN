...
def session_deleted(sender, instance, **kwargs):
    print(f"Session about to be deleted: {instance.session_key}")
    ...
    for history_dict in data['urls_history']:
        try:
            ...
            url_name = url_infos.url_name
        except Resolver404:
            url_name = None
        url, _ = Url.objects.get_or_create(url_row=history_dict['url_row'], url_name=url_name)
